...
export const inspirationProjects: InspirationProject[] = [
  {
    ...
    stars: 'active 2026',
    role: 'Idea discovery backbone',
    method: 'Use direction + constraints + prior evidence to diverge, generate candidates, check novelty risk, refine, and gate deeper work instead of one-shot brainstorming.',
    licenseNote: 'PaperForge does not vendor ARIS source; the Idea Studio core mirrors the workflow contract and can later delegate to an installed ARIS runtime.',
  },
  {
    id: 'coquest-perspectra',
    name: 'CoQuest / Perspectra',
    repo: 'https://github.com/yiren-liu/coquest',
    stars: 'research prototype',
    role: 'Human–AI co-creation',
    method: 'Keep the researcher in the loop: branch questions, reject routes, invite new perspectives, and let feedback update the research brief before another discovery round.',
    licenseNote: 'Interaction pattern inspiration; no upstream UI source is copied.',
  },
  {
    id: 'researchagent',
    name: 'ResearchAgent',
    repo: 'https://github.com/JinheonBaek/ResearchAgent',
    stars: 'research prototype',
    role: 'Literature-grounded generation',
    method: 'Generate research problems and methods from relationships across a core paper, related work, and reusable concepts rather than from a topic prompt alone.',
    licenseNote: 'Workflow inspiration only; literature retrieval remains independently implemented.',
  },
  {
    id: 'agent-laboratory',
    ...
    stars: '5k+ class',
    role: 'Independent specialist roles',
    method: 'Use separate problem, method, evidence, and experiment critics instead of asking one general reviewer to judge everything at once.',
    licenseNote: 'Role decomposition inspiration; PaperForge uses its own prompts and state model.',
  },
  {
    id: 'innoeval',
    name: 'InnoEval',
    repo: 'https://github.com/zjunlp/InnoEval',
    stars: 'research prototype',
    role: 'Structured innovation audit',
    method: 'Decompose research claims, retrieve evidence, map evidence to the exact claims under review, and keep uncertainty explicit instead of producing a single opaque novelty score.',
    licenseNote: 'Evaluation pattern inspiration; no upstream evaluation code is vendored.',
  },
  {
    id: 'deepscientist',
    name: 'DeepScientist',
    repo: 'https://github.com/ResearAI/DeepScientist',
    stars: '3k+ class',
    role: 'Findings memory',
    method: 'Persist successful and failed research routes with conditions and execution evidence so a new ideation round starts from accumulated findings instead of a blank chat.',
    licenseNote: 'Memory and project-state concepts only; PaperForge keeps an independent Findings data model.',
  },
  {
    id: 'autoresearch',
    name: 'Autoresearch',
  ...
  },
  {
    ...
    stars: '7k+ (v2)',
    role: 'Experiment-space tree search',
    method: 'After a candidate survives evidence and feasibility gates, explore alternative implementations and bounded experiment branches; prune weak routes instead of scaling every idea.',
